...
async def pattern_generator_preview(
    ...
    if ext not in {".svg",".dxf",".png",".jpg",".jpeg",".webp",".bmp",".thr"}:
        raise HTTPException(status_code=400,detail="Supported formats: SVG, DXF, PNG, JPG/JPEG, WEBP, BMP, THR")
...
async def api_v2_capabilities():
    return {"api":"v2","product":"KinetiQ Motion","pattern_generator":{"enabled":True,"formats":["svg","dxf","png","jpg","jpeg","webp","bmp","thr"]},"motion_core":"preserved-source-core"}
