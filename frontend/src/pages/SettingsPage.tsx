              ...
              <div className="flex gap-3">
                <div className="relative flex-1">
                  <Input
                    ...
                    placeholder="e.g., ORYN"
                  />
                  <Button
                    variant="ghost"
                    size="sm"
                    className="absolute right-1 top-1/2 -translate-y-1/2 h-7 w-7 p-0"
                    onClick={() => setSettings({ ...settings, app_name: 'ORYN' })}
                  >
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="led-dw" className="font-normal">ORYN LEDs (GPIO)</Label>
                </div>
              </RadioGroup>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    ...
                    <Input
                      id="mqttDeviceName"
                      value={mqttConfig.device_name || 'ORYN'}
                      onChange={(e) =>
                  ...
                  <div className="space-y-3">
                    ...
                    <Input
                      id="mqttDeviceId"
                      value={mqttConfig.device_id || 'oryn'}
                      onChange={(e) =>
